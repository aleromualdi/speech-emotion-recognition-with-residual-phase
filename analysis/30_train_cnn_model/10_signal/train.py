...
speaker emotion based on MFCCs.
'''
...
"""
Reading the mfccs of discovery data
"""
df_mfccs_disc = pd.read_csv('../../20_mfccs_rpccs/output/mfccs_disc.csv')
del df_mfccs_disc['Unnamed: 0']
...
X_mfccs = df_mfccs_disc.drop(['emotion'], axis=1)
y_mfccs = df_mfccs_disc.emotion
X_train, X_val, y_train, y_val = split(X_mfccs, y_mfccs)
